...
//                .username("phea")
//                .password(passwordEncoder.encode("123"))  // Use your existing passwordEncoder
//                .roles("USER")
//                .build();
//
