...
import istad.co.Homework.dto.Client.*;
...
public class ClientService {
    ...
    @Transactional
    public ClientResponse createAuthorizationCodeClient(AuthorizationCodeRequest request) {
    ...
    @Transactional
    public ClientResponse createClientCredentialsClient(ClientCredentialsRequest request) {
        validateClientNotExists(request.getClientId());
    ...
    private Client createBaseClient(CreatedClient request) {
    ...
    private ClientResponse createResponse(Client client, String clientType) {
